...
const ASAL_STEPS = [
  ['🎯', 'اللعبة إيه؟', 'كل واحد فيكم بيجهّز أسئلة، وبعدين الأسئلة بتتقلب على الجميع. اللي يعرف الإجابة ويكون أسرع يكسب أكتر.'],
  ['⚙️', 'الهوست بيحدد', 'الكاتيجوريز، كام سؤال من كل واحدة، <span class="hl">مستوى أسئلة البنك</span> (🟢 سهل / 🟡 متوسط / 🔴 صعب)، ووقت السؤال.'],
  ['✍️', 'لما تكتب سؤالك', 'لازم يكون <span class="hl">من نفس كاتيجوري الخانة</span>. و<span class="warn">راجع سؤالك وإجابتك قبل ما تسلّم</span> — النظام بيصحّح على اللي علّمته انت، فأي غلطة هتضيع نقط على صحابك.'],
  ...
  ['😏', 'سؤالك مبتجاوبوش', 'لما ييجي سؤال انت اللي كتبته، بتتفرج بس وانت مبسوط.'],
  ['👀', 'خلي بالك', 'فوق شريط فيه كل اللاعيبة. اللي يخرج من اللعبة وهو بيجاوب <span class="warn">هتنوّر عليه علامة ❗ قدام الكل</span>.'],
  ['🚪', 'لو خرجت', 'سكورك بيفضل محسوب في النتيجة النهائية. ولو النت قطع، ارجع بنفس الجهاز وهتلاقي مكانك زي ما هو.'],
