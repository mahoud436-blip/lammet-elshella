...
/* ======================= الهيلب ======================= */
const WISPER_STEPS = [
  ['🎭', 'اللعبة إيه؟', 'عنوان بيظهر للكل، وكل واحد بيكتب إجابته في السر. بعدين الإجابات بتتقلب من غير أسماء — ومهمتك تعرف مين كتب إيه.'],
  ['⚙️', 'الهوست بيحدد', 'عدد الجولات من كل نوع: <b>✍️</b> لاعب يكتب العنوان، <b>🗳️</b> تصويت بين 3، <b>🎲</b> عنوان عشوائي. وبعد كده اللعبة ماشية لوحدها.'],
  ['🤫', 'كاتب العنوان', 'في جولات الكتابة النظام بيختار لاعب عشوائي يكتب العنوان — <span class="hl">ومحدش هيعرف مين هو، لا دلوقتي ولا في الآخر</span>.'],
  ['🖊️', 'اكتب إجابتك', 'مخفية عن الجميع. <span class="warn">وميصحش اتنين يكتبوا نفس الكلام بالحرف</span>. وحتى عدد اللي سلّموا بيبان بنقط مجهولة من غير أسماء — عشان محدش يستنتج مين كتب إيه.'],
  ['🕵️', 'خمّنوا', 'الإجابات بتيجي <span class="hl">واحدة واحدة</span> مش كلها مرة واحدة. مع كل إجابة اختار مين كتبها — و<span class="hl">كل اسم ينفع مرة واحدة بس في الجولة</span>، فاحسبها صح.'],
  ['😏', 'إجابتك انت', 'لما تيجي، بتتفرج عليهم وهما بيدوّروا عليك.'],
  ['🏆', 'النقط', 'كل تخمينة صح = <span class="hl">100 نقطة</span>. والنتيجة بتظهر في صفحة واحدة فيها كل إجابة وصاحبها ومين خمّن صح.'],
