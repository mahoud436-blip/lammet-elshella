...
const CONAN_STEPS = [
  ...
  ['🚪', 'قطع النت وحاجات', 'لو حد قطع، اللعبة <span class="hl">بتقف وتستنّاه</span> مبتتلغيش، وتكمّل أول ما يرجع. الكلمة متتكررش في الروم أبدًا، ولو خرجت سكورك بيفضل محسوب.'],
];
function showHelp() {
