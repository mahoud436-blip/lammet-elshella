...
const LAMMAHA_STEPS = [
  ['🎯', 'اللعبة إيه؟', 'كل جولة، لاعب واحد (<span class="hl">الملمّح</span>) بيشوف اسم سري (لاعب كورة، بلد، أكلة...) و<span class="hl">بيكتب تلميح</span> يوصّفه من غير ما يقوله. الباقي بيقروا ويحاولوا يجيبوا الاسم — كله بالكتابة جوه اللعبة.'],
  ['🎲', 'الملمّح بياخد الكلمة', 'من البنك، أو يكتبها بنفسه لو الهوست سامح — ولازم يكمّل باللي اختاره. كلمة البنك يقدر يبدّلها لو صعبة، بس كلمته اللي كتبها بنفسه مش بتتبدّل.'],
  ['✍️', 'التلميح', 'يوصّف الكلمة بكلامه في <span class="hl">حدود عدد الكلمات المسموح</span>. <span class="warn">النظام بيرفض أي تلميح فيه الاسم نفسه أو حاجة قريبة منه</span>، ومفيش لزق كلمات في بعض — فيه حد لطول الكلمة.'],
