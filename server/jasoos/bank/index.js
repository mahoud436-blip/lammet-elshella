...
const CATS = [
  ...
  { id: 'things',    icon: '🔧',  name: 'أدوات وحاجات', file: './things' },
  { id: 'landmarks', icon: '🏛️', name: 'أماكن مشهورة', file: './landmarks' },
];
...
module.exports = {
  ...
  /* تخمين الجاسوس للكلمة — متسامح مع الأخطاء الإملائية */
  isMatch(item, guess) {
  ...
  /* هل الكلمة المكتوبة هي الكلمة السرية نفسها (أو قريبة منها)؟ — يترفض */
